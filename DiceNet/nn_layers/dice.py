...
class StridedDICE(nn.Module):
    ...
    '''
    def __init__(self, channel_in, height, width, kernel_size=1, dilation=[1,1,1], shuffle=True):
        '''
        :param channel_in: # of input channels
        :param channel_out: # of output channels
        :param height: Height of the input volume
        ...
        self.left_layer = nn.Sequential(CBR(channel_in, channel_in, 1, stride=1, groups=channel_in),
